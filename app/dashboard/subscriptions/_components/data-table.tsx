...
import { deleteSubscriptionsAction, updateSubscriptionStatusAction } from "@/app/dashboard/subscriptions/_actions";
...
export function DataTable({ data, columns }: DataTableProps) {
  ...
  const onDelete = async () => {
    ...
    try {
      await deleteSubscriptionsAction(ids);
  ...
  const onUpdateStatus = async (status: SubscriptionStatus) => {
    ...
    try {
      await updateSubscriptionStatusAction(status, ids);
